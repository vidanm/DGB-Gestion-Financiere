import sys
sys.path.append("/home/vidan/Documents/DGB/gestionfinanciere/src/")
...
print(post.dicPostes['CHARGES TEMPORELLES'])
data = post.dicPostes['CHARGES TEMPORELLES'].reset_index()
...
numTable.insert(0,np.array(post.dicPostes['CHARGES TEMPORELLES'].columns.values).tolist()) #####
...
c.rotate(90)
c.drawCentredString(A4[0]/2,-A4[1]+inch*0.15,"CHARGES TEMPORELLES")
